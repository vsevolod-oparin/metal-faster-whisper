...
sign_binary "$RELEASE_DIR/lib/libMetalWhisper.0.2.2.dylib" "libMetalWhisper.0.2.2.dylib" yes
...
verify_binary "$RELEASE_DIR/lib/libMetalWhisper.0.2.2.dylib" "libMetalWhisper"
