...
sign_binary "$RELEASE_DIR/lib/libMetalWhisper.0.2.1.dylib" "libMetalWhisper.0.2.1.dylib" yes
...
verify_binary "$RELEASE_DIR/lib/libMetalWhisper.0.2.1.dylib" "libMetalWhisper"
